...
export function UploadModal({ open, onOpenChange }: UploadModalProps) {
	...
	}, [deckName, file, setUploadState, navigate, handleClose, loadDecks]);
			...
			<DialogContent className="sm:max-w-md">
				...
				<div className="space-y-4">
					...
					<div className="space-y-2">
						<label className="text-sm font-medium">{t`Deck Name`}</label>
						<Input
							value={deckName}
					...
					{/* File Upload Area */}
					<div className="space-y-2">
						<label className="text-sm font-medium">{t`CSV File`}</label>
						<div
