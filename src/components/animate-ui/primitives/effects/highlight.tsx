...
function Highlight<T extends React.ElementType = 'div'>({
  ...
  const propsContainerClassName = (props as ParentModeHighlightProps)
    ?.containerClassName
  const propsItemsClassName = (props as UncontrolledParentModeHighlightProps)
    ?.itemsClassName
      ...
      if (mode === 'parent') {
        return (
          <Component
            ...
            className={propsContainerClassName}
          >
              ...
              React.Children.map(children, (child, index) => {
                const key =
                  React.isValidElement(child) && child.key
                    ? `highlight-item-${child.key}`
                    : `highlight-item-${index}`
                return (
                  <HighlightItem key={key} className={propsItemsClassName}>
                    {child}
                  </HighlightItem>
                )
              })
