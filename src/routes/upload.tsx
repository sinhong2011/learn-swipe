		...
		<div className="container mx-auto px-4 py-8 max-w-2xl">
			...
			<div className="space-y-6">
				...
				<div className="space-y-2">
					...
					>
						...
						{file ? (
							...
							<div>
								<p className="text-lg mb-4">Drop your CSV file here or click to browse</p>
								<Input
									type="file"
				...
				<Alert>
					...
					<AlertDescription>
						<strong>Expected format:</strong> Front, Back, (optional) Tags/Category columns.
						<br />
						First column = Question, Second column = Answer. Additional columns stored as extra fields.
					</AlertDescription>
				</Alert>
